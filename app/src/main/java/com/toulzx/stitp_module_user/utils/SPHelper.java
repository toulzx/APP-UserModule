...
public class SPHelper {
    ...
    public static final String KEY_RESULT_BOXES_ONLY = "resultBoxesOnly";
    ...
    public static final String VALUE_DEFAULT_AUTO_LOGIN = "false";
    public static final String VALUE_DEFAULT_RESULT_BOXES_ONLY = "false";
    ...
    public static final String VALUE_WRONG_AUTO_LOGIN = "wrong";
    public static final String VALUE_WRONG_RESULT_BOXES_ONLY = "wrong";
...
//        String autoLogin = mSharedPreferences.getString(KEY_AUTO_LOGIN, VALUE_DEFAULT_AUTO_LOGIN);
        ...
        if ( originalStatus.equals(VALUE_DEFAULT_ORIGINAL_STATUS) ) {
            ...
            editor.putString(KEY_AUTO_LOGIN, VALUE_DEFAULT_AUTO_LOGIN);
            editor.putString(KEY_RESULT_BOXES_ONLY, VALUE_DEFAULT_RESULT_BOXES_ONLY);
            editor.apply();
        ...
        Log.i(TAG, "init: SharedPreferences details: \n" +
                ...
                "IsAutoLogin:\t" + getAuto() + " \n" +
                "IsResultBoxesOnly:\t" + getResultBoxesOnly() + " \n");
    ...
    public static void setValue(String id, String username, String password,
                                String count, String loginStatus, String autoLogin, String resultBoxesOnly) {
        ...
        if (autoLogin != null) { editor.putString(KEY_AUTO_LOGIN, autoLogin); }
        if (resultBoxesOnly != null) { editor.putString(KEY_RESULT_BOXES_ONLY, resultBoxesOnly); }
        editor.apply();
    ...
    public static Map<String,String> getAll() {
        ...
        map.put(KEY_AUTO_LOGIN, getAuto());
        map.put(KEY_RESULT_BOXES_ONLY, getResultBoxesOnly());
    ...
    public static String getAuto() {
        ...
        return mSharedPreferences.getString(KEY_AUTO_LOGIN, VALUE_WRONG_AUTO_LOGIN);

    }

    public static String getResultBoxesOnly() {

        return mSharedPreferences.getString(KEY_RESULT_BOXES_ONLY, VALUE_WRONG_RESULT_BOXES_ONLY);
